...
async def send_contact_email(ctx, name: str, email: str, message: str):
    ...
    # TODO: Replace with your actual email and an App Password to enable live forwarding
    SENDER_EMAIL = "hetshahclg@gmail.com"
    APP_PASSWORD = "hhup znva wuaz lhqt"
    RECEIVER_EMAIL = "hetshah.cse24@adaniuni.ac.in"
    ...
    try:
        # Uncomment the lines below when you are ready to send live emails!
